...
INSERT INTO `cat_color` VALUES (3,3,7),(5,12,6),(15,16,4),(18,1,1),(19,1,3);
...
INSERT INTO `cats` VALUES (1,'Blue','25','1',5,1,'2'),(3,'Kitty','40','2',10,1,'5'),(16,'Bubulle','125','23',23,1,NULL);
...
INSERT INTO `colors` VALUES (1,'Blanc'),(3,'Gris'),(6,'Marron'),(2,'Noir'),(4,'Roux'),(7,'Tigré');
...
CREATE TABLE `genders` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `genderscol_UNIQUE` (`gender`)
...
-- Dump completed on 2017-12-13 10:08:38
